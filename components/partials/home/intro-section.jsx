...
import banner1 from "./../../../public/images/banners/home-page-banner.svg"
import { introSlider } from '~/utils/data/carousel';
import { fadeInUpShorter, fadeInRightShorter, fadeIn, fadeInUp, fadeInRight } from '~/utils/data/keyframes';

function IntroSection(props) {
    return (
        <OwlCarousel adClass="owl-theme" options={introSlider}>
                ...
                <div className="container">
                    <div className="banner-content y-50">
                        ...
                        <Reveal keyframes={fadeInUpShorter} delay={1000} duration={1200}>
                            ...
                            <p className="text-white ls-s mb-7">Get Free Shipping on all orders over Rs 999.00</p>
                        </Reveal>
