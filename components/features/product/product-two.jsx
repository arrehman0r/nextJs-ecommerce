                ...
                <div className="product-price">
                    {
                        product.regular_price !== product.sale_price ?
                            product.variations.length === 0 || ( product.variations.length > 0 && !product.variations[ 0 ].price ) ?
                                ...
                                :
                                < del className="new-price">Rs.{ toDecimal( product.sale_price) } – Rs.{ toDecimal( product.sale_price ) }</del>
                            : <ins className="new-price">Rs.{ toDecimal( product.regular_price  ) }</ins>
                    }
                </div>
